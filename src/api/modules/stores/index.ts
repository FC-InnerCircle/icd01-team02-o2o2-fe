...
export const storeAPI = {
  ...
  menu: {
    ...
    deleteStoresMenu: async (storeId: number, menuId: number): Promise<void> => {
      const res = await axiosInstance.delete(`${URL_ROOT}/stores/${storeId}/menus/${menuId}`);
      return res.data;
    },
  },
  ...
  order: {
    ...
    updateStoresOrder: async (storeId: number, orderId: number, payload: UpdateOrderRequest): Promise<void> => {
      const res = await axiosInstance.patch(`${URL_ROOT}/stores/${storeId}/orders/${orderId}`, payload);
      return res.data;
    },
  },
